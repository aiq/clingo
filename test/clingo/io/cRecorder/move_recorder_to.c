...
int main( void )
{
   ...
   expect_at_c_( move_recorder_to_c( rec, 2 ) );
   record_chars_c_( rec, "cd" );
   expect_mem_( mem, "__cd______" );

   expect_at_c_( move_recorder_to_c( rec, 6 ) );
   record_chars_c_( rec, "gh" );
   expect_mem_( mem, "__cd__gh__" );

   expect_at_c_( move_recorder_to_c( rec, 9 ) );
   record_chars_c_( rec, "j" );
   expect_mem_( mem, "__cd__gh_j" );

   expect_at_c_( move_recorder_to_c( rec, 0 ) );
   record_chars_c_( rec, "a" );
   expect_mem_( mem, "a_cd__gh_j" );

   expect_at_c_( not move_recorder_to_c( rec, 20 ) );
