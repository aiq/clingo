...
int main( void )
{
   ...
   expect_at_c_( *get_from_int64_vec_c( vec, 0 ) == 100 );
   expect_at_c_( *get_from_int64_vec_c( vec, 2 ) == 300 );
   expect_at_c_( *get_from_int64_vec_c( vec, 4 ) == 500 );

   set_on_int64_vec_c( vec, 4, 555 );
   expect_at_c_( *get_from_int64_vec_c( vec, 4 ) == 555 );

   insert_into_int64_vec_c( vec, 3, 350 );
   expect_at_c_( info->count == 6 );

   expect_at_c_( remove_from_int64_vec_c( vec, 2 ) );
   ...
   expect_at_c_( recorded_is_c( rec, "100 200 350 400 555" ) );
