...
int main( void )
{
   ...
   expect_at_c_( not and_bool_slice_values_c( s000 ) );
   expect_at_c_( not and_bool_slice_values_c( s001 ) );
   expect_at_c_( not and_bool_slice_values_c( s010 ) );
   expect_at_c_( not and_bool_slice_values_c( s011 ) );
   expect_at_c_( not and_bool_slice_values_c( s100 ) );
   expect_at_c_( not and_bool_slice_values_c( s101 ) );
   expect_at_c_( not and_bool_slice_values_c( s110 ) );
   expect_at_c_(     and_bool_slice_values_c( s111 ) );
