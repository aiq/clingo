= CStringList
:xmpldir: ../../../test/clingo/string/CStringList
...
Via the macros link:vec.html#OBJ_VEC_DEF_C_[OBJ_VEC_DEF_C_] and
link:vec.html#OBJ_VEC_IMPL_C_[OBJ_VEC_IMPL_C_] declared and implemented struct.
...
bool shrink_string_list_c( CStringList* vec );
/* info */
...
==== add_cs_to_string_list_c
[source,c]
----
bool add_cs_to_string_list_c( CStringList* list, char const cstr[static 1] );
----
