...
[source,c]
----
bool fget_bytes_c( FILE* file, cVarBytes bytes[static 1] );
----
...
[source,c]
----
bool fget_chars_c( FILE* file, cVarChars chars[static 1] );
----
...
[source,c]
----
bool fput_bytes_c( FILE* file, cBytes bytes[static 1] );
----
...
[source,c]
----
bool fput_chars_c( FILE* file, cChars chars[static 1] );
----
