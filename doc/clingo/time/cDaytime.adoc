...
----
/* init */
cDaytimeSlice daytime_slice_c( int64_t s, cDaytime const* v );
cDaytimeSlice make_daytime_slice_c( cDaytime const* beg, cDaytime const* end );
cDaytimeSlice empty_daytime_slice_c( void );
/* sub */
cDaytimeSlice left_daytime_slice_c( cDaytimeSlice slice, int64_t maxLen );
cDaytimeSlice mid_daytime_slice_c( cDaytimeSlice slice, int64_t index );
cDaytimeSlice right_daytime_slice_c( cDaytimeSlice slice, int64_t maxLen );
cDaytimeSlice sub_daytime_slice_c( cDaytimeSlice slice,
                                   int64_t begIdx,
                                   int64_t endIdx);
----
...
----
/* init */
cVarDaytimeSlice var_daytime_slice_c( int64_t s, cDaytime* v );
cVarDaytimeSlice make_var_daytime_slice_c( cDaytime* beg, cDaytime* end );
cVarDaytimeSlice empty_var_daytime_slice_c( void );
/* sub */
cVarDaytimeSlice left_var_daytime_slice_c( cVarDaytimeSlice slice,
                                           int64_t maxLen );
cVarDaytimeSlice mid_var_daytime_slice_c( cVarDaytimeSlice slice,
                                          int64_t index );
cVarDaytimeSlice right_var_daytime_slice_c( cVarDaytimeSlice slice,
                                            int64_t maxLen );
cVarDaytimeSlice sub_var_daytime_slice_c( cVarDaytimeSlice slice,
                                          int64_t begIdx,
                                          int64_t endIdx);
/* var slice */
cVarDaytimeSlice as_var_daytime_slice_c( cVarDaytimeSlice slice );
cVarDaytimeSlice cast_var_daytime_slice_c( cVarDaytimeSlice slice,
                                           cDaytimeSlice sub );
int64_t set_daytime_slice_c( cVarDaytimeSlice dst, cDaytimeSlice src );
----
